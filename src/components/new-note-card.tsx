  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full bg-slate-700 h-[60vh] flex flex-col rounded-md outline-none">
          ...
          <form onSubmit={handleSaveNote} className="flex flex-col flex-1">
            <div className="flex flex-1 flex-col gap-3 p-5">
              ...
              {showOnboarding ? (
                ...
                <textarea
                  autoFocus
                  className="text-sm leading-6 text-slate-400 bg-transparent resie-none flex-1 outline-none"
